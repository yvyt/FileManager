...
exports.Axios = Axios;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"error.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showError = exports.hideError = void 0;
var hideError = function hideError(type) {
  var container = document.querySelector(".container-error__".concat(type));
  container.innerHTML = "";
};
exports.hideError = hideError;
var showError = function showError(type, msg) {
  var container = document.querySelector(".container-error__".concat(type));
  var markup = "<div class=\"alert alert-danger\">".concat(msg, "</div>");
  hideError(type);
...
},{}],"management.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.sendWarningMail = exports.renderUsers = exports.renderReports = exports.renderPagination = exports.deleteOne = void 0;
...
var deleteOne = /*#__PURE__*/function () {
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "DELETE",
            url: "api/".concat(type, "s/").concat(id),
            data: {}
          });
        case 2:
          res = _context.sent;
          console.log("".concat(type, " has been deleted"));
        case 4:
        case "end":
  ...
  return function deleteOne(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
exports.deleteOne = deleteOne;
var renderPageBtn = function renderPageBtn(page, symbol) {
  var a = symbol ? symbol : page;
  var markup = "\n  <li class=\"page-item\" data-page=\"".concat(page, "\"><a class=\"page-link\" href=\"#\">").concat(symbol ? symbol : page, "</a></li>\n  ");
  return markup;
};
var renderPagination = function renderPagination(totalPages, currPage) {
  ...
  var start = currPage - 1 > 0 ? currPage - 1 : currPage;
  var i;
...
var highlightSelected = function highlightSelected(page) {
  var pageBtnsArr = Array.from(document.querySelectorAll(".page-item"));
  pageBtnsArr.forEach(function (el) {
    el.classList.remove("active");
  });
  document.querySelector(".page-item[data-page=\"".concat(page, "\"]")).classList.add("active");
};
var limitString = function limitString(string, limit) {
  if (string.length > limit) return string.substring(0, limit) + "...";
  return string;
};
var getReportContent = function getReportContent(type) {
  var reportContent = {
    0: "Spam Content",
    1: "Malware",
    2: "Phishing",
...
var displaySize = function displaySize(size) {
  return Math.floor(size / 1024 / 1024);
};
var renderReport = function renderReport(file, report) {
  var markup = "\n    <div class=\"item\" data-id=".concat(report._id, ">\n      <ul>\n        <li><img\n            src=\"./../images/file.png\"\n            alt=\"\"\n            class=\"templatemo-item\"\n          />\n        </li>\n        <li><h4><a href=\"#\">").concat(limitString(file.name, 10), "</a>\n        </h4> <span>Detail</span></li>\n        <li><h4>Ng\xE0y b\xE1o c\xE1o</h4><span>").concat((0, _moment.default)(report.modify).format("DD/MM/YYYY"), "</span></li>\n        <li><h4>N\u1ED9i dung</h4><span>").concat(getReportContent(report.type), "</span></li>\n        <li><div class=\"main-border-button warn-btn\"><a href=\"#\">C\u1EA3nh b\xE1o</a></div></li>\n        <li><div class=\"main-border-button delete-btn\"><a href=\"#\">X\xF3a File</a></div></li>\n        <li></li>\n        <!-- <li><img src=\"images/iconTrash.png\" alt=\"\" class=\"templatemo-item\"></li> -->\n      </ul>\n    </div>\n  ");
  var parent = document.querySelector(".file-library .col-lg-12");
  parent.insertAdjacentHTML("beforeend", markup);
};
var renderReports = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(currPage) {
    var page, limit, parent, res, reports;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          page = currPage || 1;
          limit = 5;
          parent = document.querySelector(".file-library .col-lg-12");
          parent.innerHTML = "";
          _context2.prev = 4;
          _context2.next = 7;
          return (0, _axios.default)({
            method: "GET",
            url: "api/reports/?page=".concat(page, "&limit=").concat(limit),
            data: {
              reports: reports
            }
          });
  ...
  return function renderReports(_x3) {
    return _ref2.apply(this, arguments);
  };
}();
exports.renderReports = renderReports;
var renderUser = function renderUser(user) {
  var markup = "\n    <div class=\"col-lg-3 col-md-6 col-sm-12 col-xs-12\">\n      <div class=\"card\" data-id=\"".concat(user._id, "\">\n        <div class=\"infos\">\n          <div class=\"image\"><img src=\"/images/user1.png\" /></div>\n          <div class=\"info\">\n            <div>\n              <p class=\"name\">\n                ").concat(user.name, "\n              </p>\n              <p class=\"role\">\n                Role:\n                ").concat(user.role, "\n              </p>\n              <p class=\"email\">\n                ").concat(user.email, "\n              </p>\n            </div>\n            <div class=\"data\">\n              <p class=\"flex flex-col\">Capacity\n                <span class=\"state-value\">").concat(displaySize(user.maxSize), "MB</span>\n              </p>\n              <p class=\"flex\">Used\n                <span class=\"state-value\">").concat(displaySize(user.usingSize), "MB</span>\n              </p>\n            </div>\n          </div>\n        </div>\n        <div class=\"dropdown\">\n          <button\n            class=\"btn btn-secondary dropdown-toggle\"\n            type=\"button\"\n            id=\"dropdownMenuButton2\"\n            data-bs-toggle=\"dropdown\"\n            aria-expanded=\"false\"\n          >\n            Action\n          </button>\n          <ul\n            class=\"dropdown-menu dropdown-menu-dark\"\n            aria-labelledby=\"dropdownMenuButton2\"\n          >\n            <li><a class=\"dropdown-item\" href=\"#\">Edit</a></li>\n            <li><hr class=\"dropdown-divider\" /></li>\n            <li class=\"delete\"><a\n                class=\"dropdown-item\"\n                href=\"#\"\n              >Delete</a></li>\n          </ul>\n        </div>\n      </div>\n    </div>\n  ");
  var parent = document.querySelector(".row");
  parent.insertAdjacentHTML("beforeend", markup);
};
var renderUsers = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(currPage) {
    var query, page, limit, parent, res, users;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          query = document.querySelector(".input-navbar").value;
          page = currPage || 1;
          limit = 4;
          ...
          return (0, _axios.default)({
            method: "GET",
            url: "api/users/?name=".concat(query, "&page=").concat(page, "&limit=").concat(limit),
            data: {
              users: users
            }
          });
        case 8:
          ...
          users = res.data.data.users; // console.log(users);
          users.forEach(function (curr) {
            return renderUser(curr);
          });
          renderPagination(res.data.totalPages, page);
          highlightSelected(page);
          _context3.next = 19;
  ...
  return function renderUsers(_x4) {
    return _ref3.apply(this, arguments);
  };
}();
exports.renderUsers = renderUsers;
var sendWarningMail = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "POST",
            url: "api/reports/sendWarning/".concat(fileId)
          });
        case 3:
          res = _context4.sent;
  ...
  return function sendWarningMail(_x5) {
    return _ref4.apply(this, arguments);
  };
}();
exports.sendWarningMail = sendWarningMail;
},{"axios":"../../node_modules/axios/index.js","moment":"../../node_modules/moment/moment.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _axios = _interopRequireDefault(require("axios"));
var _error = require("./error");
var Management = _interopRequireWildcard(require("./management"));
...
var signupBtn = document.querySelector(".input-submit__signup");
var logoutBtn = document.querySelector(".nav__logout");

// Admin pages
// const pagination = document.querySelector(".user .pagination");
var pagination = document.querySelector(".pagination");
var userContainer = document.querySelector(".container--user-list");
var reportContainer = document.querySelector(".file-library .col-lg-12");
var searchBar = document.querySelector(".input-navbar");
var btnDelete = document.querySelector(".delete");
if (reportContainer) {
  Management.renderReports();
  reportContainer.addEventListener("click", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var deleteBtn, warnBtn, card, reportId, currPage;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            deleteBtn = e.target.closest(".delete-btn");
            warnBtn = e.target.closest(".warn-btn");
            card = e.target.closest(".item");
            reportId = card.dataset.id;
            if (!deleteBtn) {
              _context.next = 9;
              break;
            }
            _context.next = 7;
            return Management.deleteOne(reportId, "report");
          case 7:
            // const currPage = e.target.closest(".page-item .active").dataset.page * 1;
            currPage = document.querySelector(".page-item.active").dataset.page * 1;
            Management.renderReports();
          case 9:
            if (warnBtn) {
...
if (userContainer) {
  ...
  userContainer.addEventListener("click", /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
      var deleteBtn, card, userId, currPage;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            userId = card.dataset.id;
            _context2.next = 6;
            return Management.deleteOne(userId, "user");
          case 6:
            // const currPage = e.target.closest(".page-item .active").dataset.page * 1;
            currPage = document.querySelector(".page-item.active").dataset.page * 1;
...
if (pagination) {
  pagination.addEventListener("click", function (e) {
    var pageBtn = e.target.closest(".page-item");
    pageBtn.classList.add(".active");
    var page = pageBtn.dataset.page * 1;
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 7:
          ...
          (0, _error.showError)("signup", _context3.t0.response.data.msg);
...
var sendResetPasswordToken = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 7:
          ...
          _context4.t0 = _context4["catch"](0);
          document.getElementById("btn-submit").innerText = "Confirm";
          (0, _error.showError)("forgotpassword", _context4.t0.response.data.msg);
        case 11:
        case "end":
          return _context4.stop();
      }
  ...
  return function sendResetPasswordToken(_x7) {
    return _ref4.apply(this, arguments);
  };
}();
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "PATCH",
            url: "api/users/resetPassword?token=".concat(token),
            data: {
              password: password,
              passwordConfirm: passwordConfirm
            }
        ...
        case 7:
          ...
          document.getElementById("btn-submit").innerText = "Confirm";
          (0, _error.showError)("resetpassword", _context5.t0.response.data.msg);
        case 11:
        case "end":
...
if (forgotPasswordForm) {
  forgotPasswordForm.addEventListener("submit", function (e) {
    e.preventDefault();
    (0, _error.hideError)("forgotpassword");
...
if (resetPasswordForm) {
  resetPasswordForm.addEventListener("submit", function (e) {
    e.preventDefault();
    (0, _error.hideError)("resetpassword");
...
// }
},{"axios":"../../node_modules/axios/index.js","./error":"error.js","./management":"management.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
